/*
Deployment script for C:\USERS\RUBEN BASENTSYAN\SOURCE\REPOS\WEBAPPLICATION1\WEBAPPLICATION1\APP_DATA\SCHEDULE.MDF
...
GO
:setvar DatabaseName "C:\USERS\RUBEN BASENTSYAN\SOURCE\REPOS\WEBAPPLICATION1\WEBAPPLICATION1\APP_DATA\SCHEDULE.MDF"
:setvar DefaultFilePrefix "C_\USERS\RUBEN BASENTSYAN\SOURCE\REPOS\WEBAPPLICATION1\WEBAPPLICATION1\APP_DATA\SCHEDULE.MDF_"
:setvar DefaultDataPath "C:\Users\Ruben Basentsyan\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\Ruben Basentsyan\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
GO
ALTER TABLE [dbo].[Colors] NOCHECK CONSTRAINT [FK_Colors_ToCourses];
...
GO
ALTER TABLE [dbo].[Entrollments] NOCHECK CONSTRAINT [FK_Entrollments_ToCourses];
...
GO
ALTER TABLE [dbo].[Entrollments] NOCHECK CONSTRAINT [FK_Entrollments_ToPersons];
